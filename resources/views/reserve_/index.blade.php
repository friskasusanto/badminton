...
<head>
    ...
    ?>
    <!-- Icons font CSS-->
    <link href="<?php echo "http://" . $pageURL; ?>/assets/vendor/mdi-font/css/material-design-iconic-font.min.css" rel="stylesheet" media="all">
    <link href="<?php echo "http://" . $pageURL; ?>/assets/vendor/font-awesome-4.7/css/font-awesome.min.css" rel="stylesheet" media="all">
    <!-- Font special for pages-->
    <link href="https://fonts.googleapis.com/css?family=Roboto:100,100i,300,300i,400,400i,500,500i,700,700i,900,900i" rel="stylesheet">

    <!-- Vendor CSS-->
    <link href="<?php echo "http://" . $pageURL; ?>/assets/vendor/select2/select2.min.css" rel="stylesheet" media="all">
    <link href="<?php echo "http://" . $pageURL; ?>/assets/vendor/datepicker/daterangepicker.css" rel="stylesheet" media="all">

    <!-- Main CSS-->
    <link href="<?php echo "http://" . $pageURL; ?>/assets/css/main.css" rel="stylesheet" media="all">
                ...
                <div class="card-body">
                    ...
                    <form action="{{url('/reserve')}}" method="POST">
                        ...
                        <div class="input-group">
                            <input class="input--style-2" type="text" placeholder="First Name" name="first" required>
                        </div>
                        <div class="input-group">
                            <input class="input--style-2" type="text" placeholder="Last Name" name="last" required>
                        </div>
                        ...
                        <div class="col-4">
                            <div class="input-group">
                                <input class="input--style-2 js-datepicker" type="text" placeholder="The date and time period of patronage" name="date">
                                <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
                            </div>
                            <div class="input-group">
...
<p> > Depending on the nature of your dealings with us, we may collect and hold other types of personal information ordinarily collected by us, such as loyalty cards, booking information, etc., which will only be used to provide you with those services.</p>
    ...
    <script>
        $('#ex1').on($.modal.BEFORE_CLOSE, function(event, modal) {
          location.replace('<?php echo "http://" . $pageURL; ?>')
        });
    </script>
